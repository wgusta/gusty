  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 flex items-start gap-4 md:gap-6 lg:gap-8 bg-off-white/95 backdrop-blur-sm px-6 md:px-8 lg:px-10 py-4 md:py-6 lg:py-8 w-full relative pb-2 md:pb-6 lg:pb-8">
      ...
      <div 
        ...
        style={{ 
          overflow: 'visible',
          width: isMenuOpen ? '150px' : '48px',
          height: isMenuOpen ? '150px' : '48px',
          position: 'fixed',
          willChange: 'transform',
        }}
      >
        ...
        <button
          ...
          style={{
            ...
            top: '-12px',
            right: '-12px',
            width: isMenuOpen ? '90px' : '48px',
            height: isMenuOpen ? '90px' : '48px',
            transform: isMenuOpen ? 'scale(1)' : undefined,
          }}
        >
          {/* X Icon - shown when menu is open, positioned at the center of the circle */}
          {isMenuOpen && (
            <svg 
              className="w-4 h-4 text-brand-white z-10 transition-opacity duration-200"
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24"
              style={{ 
          ...
          >
            ...
            >
              ...
              <Link
                ...
                rel="noopener noreferrer"
                onClick={() => setIsMenuOpen(false)}
                className="absolute w-6 h-6 rounded-full bg-brand-white flex items-center justify-center shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-sun-red focus:ring-offset-2 transition-all duration-500 touch-manipulation"
                style={{
                  top: '50%',
                  left: '100%',
                  transform: 'translate(-50%, -50%)',
              ...
              <Link
                ...
                rel="noopener noreferrer"
                onClick={() => setIsMenuOpen(false)}
                className="absolute w-6 h-6 rounded-full bg-brand-white flex items-center justify-center shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-teal focus:ring-offset-2 transition-all duration-500 touch-manipulation"
                style={{
                  top: `${50 + 50 * Math.cos((90 * Math.PI) / 180)}%`,
                  left: `${50 + 50 * Math.sin((90 * Math.PI) / 180)}%`,
                  transform: 'translate(-50%, -50%)',
