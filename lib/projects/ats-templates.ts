...
const atsTemplates: Project = {
  ...
  title: {
    ...
    de: 'Lebenslauf- und Anschreiben-Templates fuer ATS-Kompatibilitaet',
  },
  description: {
    ...
    de: 'HTML-Templates, die KI-basierte Filter und ATS-Parser bestehen und gleichzeitig visuell ansprechend fuer menschliche Reviewer bleiben. Gebaut mit semantischem HTML und CSS-Print-Stylesheets.',
  },
