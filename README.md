...
- **Clean up ATS project content and agent configs** (7c6eada) - 20 seconds ago by wgusta
- **Update Activity Log [skip ci]** (e08925a) - 9 minutes ago by github-actions[bot]
- **Security update: Upgrade Next.js to 16.0.7 and React to 19.2.1** (fbc9a51) - 9 minutes ago by wgusta
- **Security update: Upgrade Next.js to 16.0.7 and React to 19.2.1 (CVE-2025-66478)** (a2e4dd1) - 11 minutes ago by wgusta
- **Update Activity Log [skip ci]** (cc2f7fc) - 19 minutes ago by github-actions[bot]
- **Fix agent config component rendering - remove prose wrapper conflict** (f57ee84) - 19 minutes ago by wgusta
- **Add agent config display feature with accordion and copy functionality** (99f36ef) - 31 minutes ago by wgusta
